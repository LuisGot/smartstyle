    ...
    <div className="min-h-screen py-12 bg-gray-50">
      <div className="page-container">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Outfit-Vorschau mit eigenem Bild</h1>
          <p className="text-lg text-gray-600 mb-8">
            Lade ein Foto von dir hoch und sieh, wie verschiedene Outfits an dir aussehen könnten.
          </p>
          ...
          {!showResult ? (
            <div className="bg-white rounded-2xl shadow-soft p-6">
              <form onSubmit={handleSubmit}>
                {/* Upload Section */}
                <div className="mb-8">
                  <h3 className="text-xl font-semibold mb-4">1. Lade dein Bild hoch</h3>
                  <div 
                  ...
                  >
                    {uploadedImage ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-500 mb-4">Ziehe dein Bild hierher oder</p>
                ...
                {uploadedImage && (
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold mb-4">2. Wähle einen Style</h3>
            ...
            <div className="bg-white rounded-2xl shadow-soft p-6">
              <h2 className="text-2xl font-bold mb-6 text-center">Dein neues Outfit ist da!</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Dein hochgeladenes Bild</p>
                </div>
                ...
                <div>
                  ...
                  <h3 className="font-medium text-lg mb-1">Neuer Look: {selectedOutfit.style}</h3>
                  <p className="text-gray-500 text-sm">Sieht so dein Outfit aus?</p>
                </div>
              </div>
