    ...
    <nav className="bg-white shadow-sm py-4 sticky top-0 z-50">
      <div className="page-container flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <Link to="/outfit-preview" className="text-gray-600 hover:text-aqua font-medium">
            Outfit-Vorschau
          </Link>
          <Link to="/ai-fashion-advice" className="text-gray-600 hover:text-aqua font-medium">
            KI-Modeberatung
          </Link>
          <Link to="/clothing-recognition" className="text-gray-600 hover:text-aqua font-medium">
            Kleidungserkennung
          </Link>
        </div>
